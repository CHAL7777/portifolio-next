  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          aria-hidden
          className="absolute bottom-[2px] left-6 right-6 z-50 h-[2px] origin-left bg-gradient-to-r from-transparent via-[#0EA5E9] to-transparent opacity-60"
        ...
        <div className="flex items-center justify-between rounded-[2rem] border border-white/30 bg-white/65 px-5 py-3 shadow-[0_12px_45px_-20px_rgba(2,6,23,0.35)] backdrop-blur-2xl dark:border-slate-800/60 dark:bg-slate-900/68 sm:px-6">
          ...
          >
            ...
            <span className="hidden text-xl font-black tracking-tighter text-slate-900 dark:text-white sm:block">
              CHAL<span className="text-[#135DCC] italic">.</span>
            </span>
          </button>
                  ...
                  >
                    {isActive && (
                      <motion.span
                        ...
                        className="absolute inset-0 rounded-xl bg-slate-900 shadow-md dark:bg-[#135DCC]"
                      />
                    )}
                    <span
          ...
          <div className="ml-4 flex items-center gap-2.5">
            <motion.button
              ...
              className="group rounded-xl border border-slate-200 bg-white p-2.5 text-slate-600 transition-all hover:border-[#135DCC] dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
            >
            ...
            <motion.a
              ...
              className="hidden items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.14em] text-white transition-colors hover:bg-[#135DCC] dark:bg-white dark:text-slate-900 dark:hover:bg-[#0EA5E9] dark:hover:text-white lg:flex"
            >
                  ...
                  <motion.button
                    ...
                    className={`flex items-center justify-between rounded-2xl p-5 text-xl font-black ${
                      activeSection === item.id
                        ? "bg-slate-900 text-white dark:bg-[#135DCC]"
                        : "bg-slate-50 text-slate-900 dark:bg-slate-800/50 dark:text-white"
                    }`}
                  >
                    {item.label}
                    <ArrowUpRight size={20} className={activeSection === item.id ? "text-white" : "text-[#135DCC]"} />
                  </motion.button>
                ))}
              </div>
            </motion.aside>
