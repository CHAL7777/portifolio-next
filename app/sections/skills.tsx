...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "React", level: 60, icon: SiReact, color: "#61DAFB" },
      { name: "TypeScript", level: 65, icon: SiTypescript, color: "#3178C6" },
      { name: "Tailwind", level: 60, icon: SiTailwindcss, color: "#06B6D4" },
      { name: "Framer", level: 50, icon: SiFramer, color: "#0055FF" },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "MongoDB", level: 50, icon: SiMongodb, color: "#47A248" },
      { name: "Prisma", level: 50, icon: SiPrisma, color: "#2D3748" },
