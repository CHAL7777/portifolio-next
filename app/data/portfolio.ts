...
export const projects = [
  {
    ...
    category: "Commerce",
    year: "2026",
    role: "Frontend Engineer / Product UI",
    status: "Live production demo",
    image: "/project-visuals/commerce-flow.svg",
    visual: {
      label: "Commerce flow",
      alt: "Premium abstract commerce illustration with menu cards, checkout flow, and mobile ordering UI.",
      accent: "#23D48D",
      accentRgb: "35, 212, 141",
      secondary: "#F97316",
      size: "featured",
    },
  ...
  },
  {
    ...
    status: "Deployed analytics prototype",
    image: "/project-visuals/operations-dashboard.svg",
    visual: {
      label: "Operations intelligence",
      alt: "Premium operations dashboard illustration with glass analytics panels, charts, KPI widgets, and revenue signals.",
      accent: "#8B5CF6",
  ...
  },
  {
    ...
    category: "Content",
    year: "2025",
    role: "Next.js Product Developer",
    status: "Live content platform",
    image: "/project-visuals/ethio-library.svg",
    visual: {
      label: "Digital library",
      alt: "Premium digital library illustration with floating books, search UI, reading cards, and content discovery paths.",
      accent: "#D8A23B",
      accentRgb: "216, 162, 59",
      secondary: "#18B67D",
      size: "medium",
    },
  ...
  },
  {
    ...
    category: "SaaS",
    year: "2026",
    role: "SaaS Interface Engineer",
    status: "Motion-enhanced MVP",
    image: "/project-visuals/study-buddy-ai.svg",
    visual: {
      label: "AI study workspace",
      alt: "Premium AI study workspace illustration with neural nodes, planner cards, progress signals, and floating interface components.",
      accent: "#7C3AED",
